### Updates the BSL.MF_bash by making epoch parametric
# Check the following parameters in updated_bash:
# > epoch="100" &
# > --epoch $epoch
...
target_file = "<TargetPath>/MF_Frame_pos.sh"
with open(target_file, 'w') as f:
    f.write(updated_bash)
print("done")
